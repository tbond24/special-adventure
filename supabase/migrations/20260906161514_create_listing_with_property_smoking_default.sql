create or replace function public.create_vacancy_listing(
  ...
  p_room_name text, p_room_type text, p_furnished boolean, p_ensuite boolean, p_room_description text,
...
begin
  ...
  insert into public.properties(owner_id,title,suburb,city,state,postcode,country,property_type,parking_spaces,pets_considered,smoking_allowed,household_summary)
  values(v_user,p_title,p_suburb,p_city,p_state,p_postcode,coalesce(nullif(p_country,''),'Australia'),p_property_type,coalesce(p_parking_spaces,0),coalesce(p_pets_considered,false),coalesce(p_smoking_allowed,false),p_household_summary)
...
$function$;
revoke all on function public.create_vacancy_listing(text,text,text,text,text,text,text,text,text,text,text,boolean,boolean,text,numeric,numeric,boolean,date,integer,integer,integer,boolean,boolean) from public, anon;
grant execute on function public.create_vacancy_listing(text,text,text,text,text,text,text,text,text,text,text,boolean,boolean,text,numeric,numeric,boolean,date,integer,integer,integer,boolean,boolean) to authenticated, service_role;;
