const INFORMATION_PAGES={
  privacy:{title:'Privacy',intro:'How Vacancy handles information when people find, list, save and message listers about homes.',sections:[
    ['Information we collect','Account name and email; profile details you add; property, unit, availability and photo information; private property address and separately published approximate coordinates; saved vacancies; message requests and conversations; reports and blocks; and limited product events and error codes. If you choose “Use my location,” your browser supplies coordinates for the nearby search.'],
